...
class UserController < ApplicationController
  ...
  before_filter :login_required, :except => [:forgot_password, :login, :set_new_password, :reset_password,:new_dashboard]
  ...
  def choose_layout
    ...
    return 'dashboard' if action_name == 'dashboard' or action_name == 'new_dashboard'
    'application'
  end
