...
describe Autotest::RailsRspec, "file mapping" do
  ...
  it "should map view.html.erb" do
    @autotest.should map_specs(['spec/views/things/index.html.erb_spec.rb']).
                            to('app_previous/views/things/index.html.erb')
  end
